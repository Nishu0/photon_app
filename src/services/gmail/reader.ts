 ...
 * shows the public shape Photon will expose. Nothing here currently contacts
 * Gmail — the constructor will throw, documenting the expected call site.
 */
export class GmailReader {
  constructor(private readonly settings: PhotonSettings) {
...
export function triage(email: EmailShape, settings: PhotonSettings) {
